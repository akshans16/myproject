...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    UpdateTeacher() {
        ...
        setResizable(false);
        setTitle("Update Teacher Details Page");
        setLayout(null);
        ...
        JLabel selectRollNo = new JLabel("Select Your Emp ID");
        ...
        subject.setBounds(100, 300, 500, 30);
        subject.setFont(new Font("Calibri (Body)", Font.BOLD, 15));
        subject.setForeground(Color.BLACK);
        add(subject);

        cbcourses = new JLabel();
        cbcourses.setBounds(250,300,140,25);
        ...
        try {
            Conn c = new Conn();
            String query = "select * from techer where emp_ID='"+crollno.getSelectedItem()+"'";
            ...
            while(rs.next()) {
                ...
                number.setText(rs.getString("emp_ID"));
                cbcourses.setText(rs.getString("subject"));
        ...
        cancel.setBounds(490, 480, 100, 40);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update techer set Name='"+name+"', F_Name='"+fname+"', Phone='"+phone+"', Address='"+address+"',Aadhar='"+aad+"',DOB='"+dob+"',Email ='"+email+"' where emp_ID='"+crollno.getSelectedItem()+"'";
                Conn con = new Conn();
